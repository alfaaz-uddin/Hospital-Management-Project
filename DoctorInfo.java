...
public class DoctorInfo extends JFrame implements MouseListener,ActionListener{
	...
	public DoctorInfo(){
		...
		userLabel.setBounds(150,80,400,50); //x,y,width,length
		...
		userTF.setBounds(150,160,150,20);
		panel.add(userTF);*/
		...
		/*userTF = new JTextField();
		userTF.setBounds(150,190,150,20);
		panel.add(userTF);*/
		...
		//String items[] = {"CSE", "EEE", "BBA", "ARCH."};
		//langs = new JComboBox(items);
		//langs.setBounds(150,280,150,20);
		//panel.add(langs);
		...
		//userTF = new JTextField();
		//userTF.setBounds(150,310,150,20);
		//panel.add(userTF);
		...
		//userTF = new JTextField();
		//userTF.setBounds(150,340,150,20);
		//panel.add(userTF);
		...
		//userTF = new JTextField();
		//userTF.setBounds(150,370,150,20);
		//panel.add(userTF);
		...
		userLabel.setBounds(450,370,200,100); //x,y,width,length
		panel.add(userLabel);
		...
		//userTF = new JTextField();
		//userTF.setBounds(150,400,150,20);
		//panel.add(userTF);
		...
		img = new ImageIcon("images/dr-add.png");
